...
class TemaCronogramaService:
    ...
    def set_completar_tema(id_tema, fecha_actual_str):
        ...
        temas_completados = TemaCronogramaService.get_temas_completados_cronograma_semana_actual(cronograma.id_cronograma, semana_actual)
        temas_esperados = TemaCronogramaService.get_temas_completados_ideales_cronograma_semana_actual(cronograma.id_cronograma, semana_actual)
